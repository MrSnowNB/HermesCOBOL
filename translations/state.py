...
# --- 3300 Screen Attribute Flags ---
    ...
    cdemo_cust_id: str = ""
    cdemo_card_num: str = ""
    cdemo_cust_fname: str = ""
    cdemo_cust_mname: str = ""
    cdemo_cust_lname: str = ""
    acup_old_curr_bal_n: str = ""
    acup_old_credit_limit_n: str = ""
    acup_old_cash_credit_limit_n: str = ""
    acup_old_curr_cyc_credit_n: str = ""
    acup_old_curr_cyc_debit_n: str = ""
    acup_old_open_year: str = ""
    acup_old_open_mon: str = ""
    acup_old_open_day: str = ""
    acup_old_exp_year: str = ""
    acup_old_exp_mon: str = ""
    acup_old_exp_day: str = ""
    acup_old_reissue_year: str = ""
    acup_old_reissue_mon: str = ""
    acup_old_reissue_day: str = ""
    acup_old_cust_dob_year: str = ""
    acup_old_cust_dob_mon: str = ""
    acup_old_cust_dob_day: str = ""
    ...
    error_resp: int = 0
    error_resp2: int = 0
    # --- 9600-WRITE-PROCESSING fields (added in one pass) ---
    acct_update_record: Any = None
    cust_update_record: Any = None
    acct_update_id: str = ""
    acct_update_active_status: str = ""
    acct_update_curr_bal: float = 0.0
    acct_update_credit_limit: float = 0.0
    acct_update_cash_credit_limit: float = 0.0
    acct_update_curr_cyc_credit: float = 0.0
    acct_update_curr_cyc_debit: float = 0.0
    acct_update_open_date: str = ""
    acct_update_expiraion_date: str = ""
    acct_update_reissue_date: str = ""
    acct_update_group_id: str = ""
    cust_update_id: str = ""
    cust_update_first_name: str = ""
    cust_update_middle_name: str = ""
    cust_update_last_name: str = ""
    cust_update_addr_line_1: str = ""
    cust_update_addr_line_2: str = ""
    cust_update_addr_line_3: str = ""
    cust_update_addr_state_cd: str = ""
    cust_update_addr_country_cd: str = ""
    cust_update_addr_zip: str = ""
    cust_update_phone_num_1: str = ""
    cust_update_phone_num_2: str = ""
    cust_update_ssn: str = ""
    cust_update_govt_issued_id: str = ""
    cust_update_dob_yyyy_mm_dd: str = ""
    cust_update_eft_account_id: str = ""
    cust_update_pri_card_ind: str = ""
    cust_update_fico_credit_score: str = ""
    could_not_lock_cust_for_update: bool = False
    _acct_record_before_update: Any = None

import subprocess
content = """\"\"\"9600-WRITE-PROCESSING paragraph translation.\"\"\"
...
with open(
    r"C:\work\HermesCOBOL\translations\coactupc_9600_write_processing.py",
    "w",
    encoding="utf-8",
    newline="\n"
) as f:
...
result = subprocess.run(
    ["py", "-m", "py_compile",
     r"translations\coactupc_9600_write_processing.py"],
    capture_output=True, text=True,
    cwd=r"C:\work\HermesCOBOL"
)
print("Syntax check:", result.returncode, result.stderr)

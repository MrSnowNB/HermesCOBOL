# COACTUPC Statement-Level IR Extraction — v1 Final
**Date**: 2026-05-27
**Status**: Complete (PERFORM + SET + External tagging)

## Summary
- Total paragraphs: **78**
- Paragraphs with PERFORM: **10**
- Total PERFORM statements: **59**
- External targets detected: **4**
  - ['ABEND-ROUTINE', 'EDIT-DATE-CCYYMMDD', 'EDIT-DATE-OF-BIRTH', 'YYYY-STORE-PFKEY']

## Sample Paragraphs with Performs + External Flags
### 0000-MAIN
```json
{
  "program": "COACTUPC",
